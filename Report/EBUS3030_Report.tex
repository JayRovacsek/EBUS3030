\documentclass{article}
    ...
    SELECT Reciept_Id,Customer_ID,Staff_ID FROM CTE WHERE (RowNumber % 2 = 0)
            ...
            \par
            With this known, and additional section was added to the Python script to generate update statements
    ...
    ORDER BY [SubQuery].[ReceiptId]
            ...
            written for generation of SQL in python which resulted in two queries for each
